...
//Create an empty object to store Server Sent Event(sse) connections
const connections = {};

//Controller function for the SSE endpoint(one-way real time commu server->client)
export const sseController = (req, res) => {
  ...
  //Send an initial event to the client in JSON format
